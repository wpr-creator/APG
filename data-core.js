...
const REQ_DOCS = [
  ...
  { name: "Federalist No. 78", type: "Federalist Paper", year: "1788" },
  ...
  "periods": [
    {
      ...
      "label": "Period 1A",
      "students": [
        "Abucejo, Aaliyah Jade F.",
        "Agustin, Joseph T.",
        "Alvarez, Amaya M.",
        "Ayuyao, Glenn Nicholas B.",
        "Begonia, Erica Tricia Mariae P.",
        "Boatman, Johnny R.",
        "Buan, Angel B.",
        "Carrillo, Brianna A.",
        "Castelan, Dania P.",
        ...
        "Curtis, Malcolm A.",
        "Esquivel, Mila M.",
        "Garcia-Rosas, Samuel V.",
        "Giles, Leila M.",
        "Guevara, Jennifer",
        "Haro Miranda, Emily G.",
        "Hawkins, Jayden C.",
        "Hill, Adwoa O.",
        "Kinder, Delila M.",
        "LaPierre, Robert",
        "Lopez, Clarence A.",
        "Lopez Magana, Jimena A.",
        "Ly, Morgan L.",
        "Macasinag, Jyrehl Ponce",
        "Nguyen, Christina",
        "Ofoegbu, Daniel K.",
        "Olguin Roman, Abigail",
        "Ortiz, Sumayyah A.",
        "Pascua, Renata S.",
        "Perales, Emiliano",
        "Quiroz, Brandon",
        ...
        "Tojino, Adrian B.",
        "Vargas, Rogelio J.",
        "Vargas Portillo, Miguel A.",
        "Velasco, Mattiello Aidan O.",
        "Woldeyesus, Natal B."
      ]
    },
    {
      ...
      "students": [
        "Alvarez, Ana S.",
        "Asanas, Noah Alfredo R.",
        "Barragan, Kathia",
        "Bontty, Charlize A.",
        "Cortez Vega, Aldo J.",
        "Covarrubias, Adriana A.",
        "Covarrubias, Javier M.",
        "Edquiban, Frecia Claire B.",
        "Golmes, Abraham",
        "Guiao, Caeden Homer C.",
        "Johnson, Tyler D.",
        "Jones, Jeyron",
        "Lares Minquini, Diego",
        "Lopez Lomeli, Giovanny",
        "Lozano, Cassandra",
        "Luna, Izel",
        "Magallanes, Samirah M.",
        "Magno, Reuben A.",
        "Medina, Liliana I.",
        "Mendez, Sarai P.",
        "Mendivil, Sebastian I.",
        "Mompremier, Nolan C.",
        "Mora, Pia M.",
        "Moreno Munoz, Stephanie",
        "Onephonesy, Ava C.",
        "Ramirez, Jan Isaac F.",
        "Reynoso, Airam A.",
        "Roasa, Jirell Z.",
        "Roman, Marco A.",
        "Sagisi, Jaiden M.",
        "Suarez Cruz, Rebeca M.",
        "Sweet, Marquise",
        "Tamayo, Michael A.",
        "Vigil, Camila A.",
        "Villa Araujo, Vicente",
        "Villarin, Kian Jasper D.",
        "Wibowo-Garcia, Aiwa",
        "Wong, Aizen J.",
        "Zamora, Blanca I."
      ]
