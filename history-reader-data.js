window.HISTORY_SECTION_DATA = {
  ...
  articles: {
    ...
    sections: [
      ...
      { heading: "WHAT COULD CONGRESS DO?", bullets: ["Declare war and make peace", "Make treaties and manage foreign relations", "Coin money", "Ask states for money and soldiers"] },
      { heading: "WHAT COULD CONGRESS NOT DO?", bullets: ["Collect taxes directly from the people", "Regulate trade between the states", "Enforce its own decisions", "Use a president or national courts; neither existed"] },
  ...
  convention: {
    ...
    sections: [
      ...
      { heading: "ENFORCEMENT AND COURTS", text: "The Articles had no executive to enforce national decisions and no national courts to settle disputes. Article II created the presidency. Article III created an independent federal judiciary. Separation of powers and checks and balances kept either branch from controlling the whole government." },
      { heading: "NATIONAL AUTHORITY", text: "States could ignore national decisions under the Articles. The Supremacy Clause gave valid federal law priority when it conflicted with state law. The rule of law bound officials and citizens to the Constitution and the law." },
